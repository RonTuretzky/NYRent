...
// Imports ensure isolated artifacts for the real protocol implementations.
...
/// @notice LOCAL TEST ONLY: no mainnet funds, freely mintable six-decimal dollars.
contract V4E2ECurrency is ERC20 {
    constructor() ERC20("USDC (local test only)", "USDC") {}
